...
function platformSuffix(string $target): string
{
    return match ($target) {
        ...
        'both' => 'Platform target: Web dan Mobile Android.' . PHP_EOL
            . 'Tech stack Web: Laravel 13 (PHP 8.3) + Next.js (App Router, React 19, TypeScript) + Tailwind CSS v4 + PostgreSQL 16.' . PHP_EOL
...
function techStackShort(string $target): string
{
    return match ($target) {
        ...
        'both' => 'Web: Laravel 13 + Next.js + React 19 + Tailwind CSS v4 + PostgreSQL 16 | Mobile: Flutter + Dart + Riverpod + GoRouter + Material Design 3',
