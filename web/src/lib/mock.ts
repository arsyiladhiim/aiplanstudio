...
const ALL_STAGES: { key: StageKey; label: string; desc: string; gate: StageGateName }[] = [
  { key: "pertanyaan", label: "Klarifikasi", desc: "AI mengajukan pertanyaan klarifikasi (MCQ) tentang ide kamu.", gate: GATE_MAP.pertanyaan },
  { key: "analisa", label: "Analisa", desc: "AI menganalisa ide berdasarkan jawaban kamu.", gate: GATE_MAP.analisa },
  { key: "prd", label: "PRD", desc: "Dokumen kebutuhan produk terstruktur.", gate: GATE_MAP.prd },
  { key: "architecture", label: "Arsitektur", desc: "Struktur folder & pilihan teknologi.", gate: GATE_MAP.architecture },
  { key: "erd", label: "ERD", desc: "Skema data + relasi tabel.", gate: GATE_MAP.erd },
  { key: "api_contract", label: "API Contract", desc: "Daftar endpoint REST per resource.", gate: GATE_MAP.api_contract },
  ...
  { key: "pertanyaan_mobile", label: "Mobile — Klarifikasi", desc: "AI mengajukan pertanyaan klarifikasi khusus mobile (MCQ).", gate: GATE_MAP.pertanyaan_mobile },
  { key: "standards_mobile", label: "Mobile — Standards", desc: "STANDARDS.md untuk proyek mobile.", gate: GATE_MAP.standards_mobile },
  { key: "phases_mobile", label: "Mobile — Phases", desc: "Breakdown fase pembangunan mobile.", gate: GATE_MAP.phases_mobile },
  { key: "master_mobile", label: "Mobile — Master Prompt", desc: "Master prompt self-contained untuk AI agent mobile.", gate: GATE_MAP.master_mobile },
  { key: "app_spec_mobile", label: "App Spec — Mobile", desc: "Registry screens, navigation, flows, dan widgets Flutter (JSON).", gate: GATE_MAP.app_spec_mobile },
  { key: "env_config", label: "Env & Config", desc: "Dokumen environment variables per platform.", gate: GATE_MAP.env_config },
  { key: "security", label: "Security Checklist", desc: "OWASP checklist production-ready.", gate: GATE_MAP.security },
...
export function getStages(target: Target): { key: StageKey; label: string; desc: string; gate: StageGateName }[] {
